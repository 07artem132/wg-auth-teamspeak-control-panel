<table border="1">
    ...
    <tr>
        <td style="text-align: center" colspan="17"><a
                    href="/teamspeak/{{ $InstanseID }}/{{$ServerUID}}/module/{{$modulesID}}/wotplayers/add">
    ...
    @foreach ($Instanses as $Instanse)
        <tr>
            ...
            <td style="text-align: center"><a
                        href="/teamspeak/{{ $InstanseID }}/{{$ServerUID}}/module/{{$modulesID}}/wotplayers/{{$Instanse['id']}}/edit">изменить
