...
class CreateServerWgAuthNotifyAuthSuccessGroupsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('server_wg_auth_notify_auth_success_groups', function (Blueprint $table) {
	        $table->increments('id');
    ...
    {
        Schema::dropIfExists('server_wg_auth_notify_auth_success_groups');
    }
}
